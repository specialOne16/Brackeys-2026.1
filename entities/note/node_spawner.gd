...
func _process(_delta: float) -> void:
	...
	while _current_notes_index < beatmap_notes.size() and song_timestamp >= beatmap_notes[_current_notes_index].time:
		_spawn_note(beatmap_notes[_current_notes_index])
